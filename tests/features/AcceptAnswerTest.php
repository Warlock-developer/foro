...
class AcceptAnswerTest extends FeatureTestCase
{
    ...
    function test_non_post_author_dont_see_the_accept_answer_button()
    {
    ...
    //prueba de regresión
    //los usuarios que no son dueños del post, no pueden aceptar la respuest
    ...
    function test_the_accept_button_is_hidden_when_the_comment_id_already_the_post_answer()
    {
